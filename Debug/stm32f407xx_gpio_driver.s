...
.L27:
	...
	cmp	r3, r2
	beq	.L29
	.loc 1 222 106 discriminator 1
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 1
	ldr	r2, .L49+8
	cmp	r3, r2
	beq	.L30
	.loc 1 222 179 discriminator 3
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 3
	ldr	r2, .L49+12
	cmp	r3, r2
	beq	.L31
	.loc 1 222 252 discriminator 5
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 5
	ldr	r2, .L49+16
	cmp	r3, r2
	beq	.L32
	.loc 1 222 325 discriminator 7
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 7
	ldr	r2, .L49+20
	cmp	r3, r2
	beq	.L33
	.loc 1 222 398 discriminator 9
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 9
	ldr	r2, .L49+24
	cmp	r3, r2
	beq	.L34
	.loc 1 222 471 discriminator 11
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 11
	ldr	r2, .L49+28
	cmp	r3, r2
	beq	.L35
	.loc 1 222 544 discriminator 13
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 13
	ldr	r2, .L49+32
	cmp	r3, r2
	beq	.L36
	.loc 1 222 617 discriminator 15
	ldr	r3, [r7, #4]
	ldr	r3, [r3]
	.loc 1 222 10 discriminator 15
	ldr	r2, .L49+36
	cmp	r3, r2
	bne	.L37
	.loc 1 222 10 is_stmt 0 discriminator 17
	movs	r3, #8
	b	.L46
.L37:
	.loc 1 222 10 discriminator 18
	movs	r3, #0
	b	.L46
.L36:
	.loc 1 222 10 discriminator 16
	movs	r3, #7
	b	.L46
.L35:
	.loc 1 222 10 discriminator 14
	movs	r3, #6
	b	.L46
.L34:
	.loc 1 222 10 discriminator 12
	movs	r3, #5
	b	.L46
.L33:
	.loc 1 222 10 discriminator 10
	movs	r3, #4
	b	.L46
.L32:
	.loc 1 222 10 discriminator 8
	movs	r3, #3
	b	.L46
.L31:
	.loc 1 222 10 discriminator 6
	movs	r3, #2
	b	.L46
.L30:
	.loc 1 222 10 discriminator 4
	movs	r3, #1
	b	.L46
.L29:
	...
	movs	r3, #0
.L46:
	.loc 1 222 10 discriminator 36
	strb	r3, [r7, #13]
	.loc 1 223 53 is_stmt 1 discriminator 36
	ldr	r3, .L49+40
	ldr	r3, [r3, #68]
	ldr	r2, .L49+40
	orr	r3, r3, #16384
	str	r3, [r2, #68]
	.loc 1 224 60 discriminator 36
	ldr	r2, .L49+44
	ldrb	r3, [r7, #15]	@ zero_extendqisi2
	adds	r3, r3, #2
	ldr	r2, [r2, r3, lsl #2]
	.loc 1 224 73 discriminator 36
	...
	adds	r3, r3, #2
	str	r2, [r1, r3, lsl #2]
	.loc 1 226 49 discriminator 36
	ldr	r3, .L49
	ldr	r3, [r3]
	.loc 1 226 85 discriminator 36
	ldr	r2, [r7, #4]
	ldrb	r2, [r2, #4]	@ zero_extendqisi2
	mov	r1, r2
	.loc 1 226 55 discriminator 36
	movs	r2, #1
	lsls	r2, r2, r1
	mov	r1, r2
	.loc 1 226 49 discriminator 36
