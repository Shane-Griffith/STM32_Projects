...
# 48 "C:/Users/shane/Documents/Repo/STM32_Projects/stm32f4xx_drivers/Drivers/Inc/stm32f407xx_gpio_driver.h"
...
# 46 "C:/Users/shane/Documents/Repo/STM32_Projects/stm32f4xx_drivers/Drivers/Inc/stm32f407xx_SPI_driver.h"
...
# 56 "C:/Users/shane/Documents/Repo/STM32_Projects/stm32f4xx_drivers/Drivers/Inc/stm32f407xx_SPI_driver.h" 3 4
_Bool 
# 56 "C:/Users/shane/Documents/Repo/STM32_Projects/stm32f4xx_drivers/Drivers/Inc/stm32f407xx_SPI_driver.h"
...
# 64 "../Drivers/Src/stm32f407xx_SPI_driver.c"
void SPI_PeriClockControl(SPI_RegDef_t *pSPIx, uint8_t enordi){
 switch(enordi){
 case 1:
...
void SPI_SendData(SPI_RegDef_t *pSPIx, uint8_t *pTxbuffer, uint32_t len)
{
 ...
 while(len > 0)
 {
  while(!(get_reg_value((uint32_t*)pSPIx, 3, 1)))
  {
...
void SPI_busConfig(SPI_Handle_t *pSPIHandler, uint8_t tx_or_rx)
{
 ...
 {
  pSPIHandler->pSPIx->1 |= (0 << 15);

  pSPIHandler->pSPIx->1 |= (0 << 14);

  pSPIHandler->pSPIx->1 |= (0 << 10);

 }
 else if(pSPIHandler->SPI_Config.BusConfig == (uint8_t)(1) || pSPIHandler->SPI_Config.BusConfig == (uint8_t)(3))
 {
  pSPIHandler->pSPIx->1 |= (1 << 15);
...
# 189 "../Drivers/Src/stm32f407xx_SPI_driver.c" 3 4
_Bool 
# 189 "../Drivers/Src/stm32f407xx_SPI_driver.c"
    get_reg_value(uint32_t *address, uint32_t spi_register, uint8_t register_bit)
{
 uint32_t result = (*(address + (sizeof(uint32_t) * spi_register)) & (0xffffffff));

 if(result >> register_bit == 1)
 {
  return 
# 195 "../Drivers/Src/stm32f407xx_SPI_driver.c" 3 4
        1
# 195 "../Drivers/Src/stm32f407xx_SPI_driver.c"
            ;
 }
 else
 {
